...
public class DashboardForm extends JFrame {
    ...
    public DashboardForm() {
        ...
        btnEdit.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                DefaultTableModel dTblModel = (DefaultTableModel) ClientsTable.getModel();

                if (ClientsTable.getSelectedRowCount() == 1) {
                    String[] data = {tfFirstLastName.getText(), tfEamil.getText(), tfPhone.getText(), tfAddress.getText()};

                    if (tfFirstLastName.getText().isEmpty() || tfEamil.getText().isEmpty() ||
                            tfPhone.getText().isEmpty() || tfAddress.getText().isEmpty()) {
                        JOptionPane.showMessageDialog(null, "Ktores pole jest puste, podaj wszystkie dane!");
                    } else {
                        dTblModel.setValueAt(data[0], ClientsTable.getSelectedRow(), 0);
                        dTblModel.setValueAt(data[1], ClientsTable.getSelectedRow(), 1);
                        dTblModel.setValueAt(data[2], ClientsTable.getSelectedRow(), 2);
                        dTblModel.setValueAt(data[3], ClientsTable.getSelectedRow(), 3);
                        JOptionPane.showMessageDialog(null, "Poprawnie edytowano dane");
                    ...
                    if (ClientsTable.getRowCount() == 0) {
                        JOptionPane.showMessageDialog(null, "Brak danych do edytowania");
                    } else {
                        JOptionPane.showMessageDialog(null, "Wybierz jeden wiersz danych!");
                    }
                }
            }
        });
